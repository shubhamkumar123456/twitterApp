...
const { createPost, deletePost, updatePost, getAllUserPost, getSingleUserPost, updateLike, addComment, getSinglePostComments } = require('../controllers/postController');
